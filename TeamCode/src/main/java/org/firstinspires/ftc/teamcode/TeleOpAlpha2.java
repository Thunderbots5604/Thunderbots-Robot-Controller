...
public class GodFatherOfAllAutonomous extends LinearOpMode {
    ...
    public final float TICKS_MULTIPLIER = 20F / 23F;
    //For next time, ticks_per_strafe should be numerator
    ...
    public float strafePower_LRF = Math.abs(50 / TICKS_PER_STRAFE_LRF);
    public float strafePower_LRB = Math.abs(50 / TICKS_PER_STRAFE_LRB);
    public float strafePower_RLF = Math.abs(44 / TICKS_PER_STRAFE_RLF);
    public float strafePower_RLB = Math.abs(47 / TICKS_PER_STRAFE_RLB);
    public float strafePower_RRF = Math.abs(44 / TICKS_PER_STRAFE_RRF);
    public float strafePower_RRB = Math.abs(50 / TICKS_PER_STRAFE_RRB);
    ...
    */
    ...
    public double colorRun3 = 4 + colorRun2;
    public double colorRun4 = 80;
    public double colorRunToWall = 41;
    public double colorRun5 = colorRun4 + 36;
    public double colorRun6 = colorRun5 - 6;
    public double colorRun7 = 12;
    ...
    public double foundationRun1 = 15;
    public double foundationRun2 = 20;
    public double foundationRun3 = 48;
    public double foundationRun4 = 20;
    public double foundationPower1 = .8;
    public double foundationPower2 = .6;
    public double foundationStrafe1 = 75;
    public double foundationRun5 = 30;
    ...
    public void strafeRight(double inches, double power, double slowerPower) {
        ...
        while ((leftMotorFront.getCurrentPosition() < targetStrafe_RLF) && (rightMotorBack.getCurrentPosition() < targetStrafe_RRB) && (leftMotorBack.getCurrentPosition() > targetStrafe_RLB) && (rightMotorFront.getCurrentPosition() > targetStrafe_RRF) && opModeIsActive() && runtime.milliseconds() < 4000) {
            ...
            rightMotorBack.setPower(slowerPower * strafePower_RRB);
        }
        leftMotorFront.setPower(0);
        leftMotorBack.setPower(0);
        rightMotorFront.setPower(0);
    ...
    public void accurateTurnRight(double targetAngle, double power) {
        ...
        angle = getAngle();
        if ((targetAngle < angle && side == 2) || (targetAngle > angle & side == 1)) {
            return;
        }
